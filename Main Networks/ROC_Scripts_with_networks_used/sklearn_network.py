...
df = pd.read_hdf('/home/szymon/PycharmProjects/test/particle_data_big_kaon0_pion1_proton2.h5',stop=100000)
...
for i in range(3):
    ...
    temp_labels = []
    temp_predictions = prediction.T[0] #(iterates through the columns)
...
np.save("np_prediction_SKlearn", prediction)
np.save("np_y_SKlearn", y_test)
# evaluation
