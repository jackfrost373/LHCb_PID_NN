...
file_numbers = np.linspace(0, 12, 13) # Makes an array to access every folder in /home/Shared/lhc.data/ganga/20.
...
total_data_kaon_pion_proton_hdf5 = total_data_kaon_pion_proton.to_hdf('/home/Shared/students/particle_data_big_13_kaon0_pion1_proton2.h5', key = 'kaon_pion_proton', format = 'table')